...
/**
 * THIS IS A POTENTIALLY TO-BE-MODIFIED COPY OF THREEJS TRANSFORMCONTROLS
 */
...
class TransformControls extends Controls {
	 ...
	 */
	constructor(camera, domElement: any = null) {
	...
	pointerMove(pointer) {
		...
		if (mode === 'translate') {
			...
			/* console.log('object.position: ' + JSON.stringify(object.position, undefined, 4)) */
		} else if (mode === 'scale') {
